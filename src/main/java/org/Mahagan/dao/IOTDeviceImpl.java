...
public class IOTDeviceImpl implements IOTDevice {
    ...
    private final String SQL_Find_Device = "select * from iotdevice1 where id= ?";
    //Deleting records
    private final String SQL_Delete_Device = "delete from iotdevice1 where id= ?";
    //Updating records from fields taken below
    private final String SQL_Update_Device = "update iotdevice1 set deviceName= ?,deviceLocation= ?, deviceFunction= ? where Id= ?";
    //Getting all records
    private final String SQL_Get_All_Device = "select * from iotdevice1";
    //Inserting new values into iotdevice
    private final String SQL_Insert_Device = "insert into iotdevice1(id,deviceName,deviceLocation,deviceFunction) values(?,?,?,?)";
